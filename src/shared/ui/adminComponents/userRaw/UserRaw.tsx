    ...
    return (
        <>
            <tr className={'border-b-2 border-light-primary-main '}>
                <td className={'p-1  text-center border-light-primary-main  border-r-2'}>{index + 1}</td>
                ...
                <td className={'p-1  text-center border-light-primary-main  border-r-2'}>
                    {user.role}
                </td>
                <td className={'flex justify-center gap-3 p-1'}>
                    <Button theme={ButtonThemes.FILLED} className={'!px-4 !py-1'}>Ban</Button>
                    <Button theme={ButtonThemes.FILLED} className={'!px-4 !py-1'} onClick={openHandler}>Edit</Button>
                </td>

            </tr>
            <Modal classname={'max-w-[400px] w-full'} isOpen={isEditable} setIsOpen={openHandler}>
