        ...
        <>
            ...
            <div className={'flex justify-between bg-neutral-800 p-5 rounded-md'}>
                ...
                <div className={'flex items-center '}>
                    <div>
                        {
                            user.avatar.length === 0 ? <div
                                    onClick={setAvatarModalOpenHandler}
                                    className={'w-32 h-32 rounded-full bg-dark-primary-main border-[1px] cursor-pointer hover:opacity-70 object-cover'}/>
                                :
                                <Image src={user.avatar} alt={'user-avatar'} width={1920} height={1080}
                                       onClick={setAvatarModalOpenHandler}
                                       className={'w-32 h-32 rounded-full border-[1px] cursor-pointer hover:opacity-70 object-cover'}/>
                        }

                        <Modal isOpen={avatarModalOpen} setIsOpen={setAvatarModalOpenHandler}>
                            <UploadButton
                                appearance={{
                                    button: 'bg-dark-primary-hover-second hover:opacity-70 duration-300'
                                }}
                        ...
                        <Notification open={uploadNotificationOpen} onClose={setUploadNotificationOpenHandler}
                                      timeoutDelay={3000} isSuccess={!uploadError}>
                    ...
                    <div className={'ml-5 flex flex-col gap-2'}>
                        ...
                        <div>
                            <span className={'px-2 py-1 bg-light-primary-main rounded-full'}>{user.role}</span>
                ...
                <div className={'flex items-end gap-x-2'}>
                    <Button theme={ButtonThemes.FILLED} onClick={openHandler}>Edit</Button>
