            ...
            <div className={'w-[300px]'}>
                ...
                <div className={'flex justify-between my-3'}>
                    <div className={'flex text-md gap-x-2'}>
                        {
                            Array(course.rating).fill(null).map(star => {
                                return <AiOutlineStar className={'text-yellow-300'}/>
                            })
                        }
                        {
                            Array(stars).fill(null).map(star => {
                ...
                <Link href={`/user/my-courses/course/${course.id}`}>
